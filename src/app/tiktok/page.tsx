      ...
      <section className="pb-16 sm:pb-20 px-4 sm:px-6 lg:px-12">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          ...
          >
            ...
            >
              <button
                className="bg-primary-neon text-black px-6 py-3 rounded-xl font-semibold hover:bg-primary-neon/90 transition-colors inline-flex items-center justify-center w-full"
              >
