      ...
      >
        ...
        <div className="mb-6">
          <div className="w-full bg-gray-200 rounded-full h-2">
            <motion.div
              className="bg-primary-neon h-2 rounded-full"
              initial={{ width: "100%" }}
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full bg-primary-neon text-black py-3 px-6 rounded-xl font-semibold hover:bg-primary-neon/90 transition-colors"
          >
            Download Now
          </button>
