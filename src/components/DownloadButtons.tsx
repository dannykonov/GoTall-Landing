...
export default function DownloadButtons({ 
  ...
  const { isTikTokBrowser, openInExternalBrowser } = useTikTokBrowser()
  ...
  const handleAppStoreClick = async () => {
    ...
    if (isTikTokBrowser) {
      // Only apply TikTok handling for App Store
      const success = await openInExternalBrowser('https://apps.apple.com/us/app/gotall/id6747467975')
      
      if (!success) {
        alert('Unable to open App Store. Please copy this link and paste it in your external browser: https://apps.apple.com/us/app/gotall/id6747467975')
      }
    } else {
