...
export default function DownloadButtons({ 
  ...
  const tiktokLongPressHelp = showTikTokLongPressHint ? (
    <div className="mt-3 text-center text-xs sm:text-sm text-primary-gray">
      ...
      <div className="mt-2 mx-auto w-full sm:w-[496px] overflow-hidden">
        <img
      ...
      <div className="w-full sm:w-auto">
        <div className={`flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center w-full sm:w-auto ${className}`}>
          <motion.a
            ...
            rel="noopener noreferrer"
            onClick={handleAppStoreClick}
            className="bg-brand-gradient text-black px-4 sm:px-6 py-3 rounded-xl font-semibold hover:opacity-90 transition-opacity inline-flex items-center justify-center group w-full sm:min-w-[140px] h-[48px] sm:h-auto"
          >
